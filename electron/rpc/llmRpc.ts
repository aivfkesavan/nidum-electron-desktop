...
import { createElectronSideBirpc } from "../utils/createElectronSideBirpc";
import { llmFunctions, llmState } from "../state/llmState";
import type { RenderedFunctions } from "../../src/rpc/llmRpc";
...
export class ElectronLlmRpc {
    ...
    public readonly functions = {
        ...
        getChatHistory: llmFunctions.chatSession.getChatHistory,
        setChatHistory: llmFunctions.chatSession.setChatHistory,
    } as const;
