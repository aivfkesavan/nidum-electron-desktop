...
import {
    ChatHistoryItem,
    getLlama, Llama, LlamaChatSession, LlamaChatSessionPromptCompletionEngine,
    LlamaContext, LlamaContextSequence, LlamaModel
} from "node-llama-cpp";
...
export const llmFunctions = {
    ...
    chatSession: {
        ...
        setChatHistory(items: ChatHistoryItem[]) {
            return chatSession?.setChatHistory(items)
        }
    }
} as const;
