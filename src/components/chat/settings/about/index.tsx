...
function About() {
  return (
    <div className="text-xs text-white/80">
      <p className="mb-4">Current Version: RAGDrive Version {packageJson.version} (Codename - Madurai)</p>
      ...
      <p className="mb-4">There will also be Text to Image and Video support in your RAGDrive in the near future.</p>
      ...
      <p className="mb-4">If you want to launch your plugins in RAGDrive, get in touch with us.</p>
    </div>
  )
}
