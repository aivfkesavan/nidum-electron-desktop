...
const appId = "com.nidum.ai.ragdrive";
const productName = "RAGDrive";
const executableName = "RAGDrive";
const appxIdentityName = "com.nidum.ai.ragdrive";
